...
from plane_estimation.loss import depth_loss, instance_aware_loss, total_loss2
    ...
    with torch.no_grad():
        for image_path in images:
            ...
            _, _, _, _, plane_depth, instance_param = total_loss2(
                mask_lst[0], param[0], k_inv_dot_xy1, valid_region,
                torch.ones((1, 1, h, w)), torch.ones((1, 1, h, w)), return_loss=False)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--bts_input', type=tuple, default=(192, 256), help='bts input image shape')
    ...
    parser.add_argument('--plane_cls', type=str, default='0,1,5,7', help='plane categories: floor,wall,ceiling,etc')

...
class SOLOV2HeadDCN(nn.Module):
    ...
    def __init__(self,
                 ...
                 use_dcn_in_mask_feat=False,
                 type_dcn=None,
                 freeze_params=False
                 ):
        super(SOLOV2HeadDCN, self).__init__()
        ...
        self.use_dcn_in_mask_feat = use_dcn_in_mask_feat
        self.type_dcn = type_dcn
        self._init_layers()

        self.freeze_params = freeze_params
        if self.freeze_params:
            for m in [self.feature_convs, self.kernel_convs, self.cate_convs,
                      self.solo_kernel, self.solo_cate, self.solo_mask]:

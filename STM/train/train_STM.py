...
from STM.dataloader.train_stm_stage1 import YOUTUBE
from STM.dataloader.train_gcm_stage2 import YOUTUBE2
from STM.dataloader.train_stm_stage3 import DAVIS3

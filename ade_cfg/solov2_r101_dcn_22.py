...
data = dict(
    ...
    train=dict(
        type=dataset_type,
        ann_file=data_root + 'indoor_train.json',
        img_prefix=data_root + 'panoptic/train/',
        pipeline=train_pipeline),
    val=dict(
        type=dataset_type,
        ann_file=data_root + 'indoor_val.json',
        img_prefix=data_root + 'panoptic/val/',
        pipeline=test_pipeline),
    test=dict(
        type=dataset_type,
        ann_file=data_root + 'ade_val.json',
        img_prefix=data_root + 'panoptic/val/',
        pipeline=test_pipeline))
# optimizer
...
log_level = 'INFO'
work_dir = './work_dirs/ade_dcn_aug'
load_from = './work_dirs/ade_dcn_total/epoch_48.pth'

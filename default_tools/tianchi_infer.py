...
imgs = sorted(glob.glob('/versa/dyy/dataset/TIANCHI/PreRoundData/JPEGImages/*/*.jpg'))
...
for idx, img_path in enumerate(imgs):
    ...
    if cur_result is not None:
        ...
        if len(masks) > 0:
            ...
            blend = Image.fromarray(blend)
        save_dir = os.path.join('/versa/dyy/dataset/TIANCHI/PreRoundData/solo_result', video_id)

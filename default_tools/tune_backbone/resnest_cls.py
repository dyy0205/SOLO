...
from mmdet.models import ResNeSt


class ResNeSt_cls(ResNeSt):
    def __init__(self, depth, num_classes=4, pretrained=None):
...
if __name__ == '__main__':
    model = ResNeSt_cls(depth=101, num_classes=21,
    ...
    data_dir = '/versa/dyy/dataset/ADE/panoptic'
    ...
    for epoch in range(num_epochs):
        ...
        torch.save(model.module.state_dict(),
                   '/versa/dyy/backbone_tuned/{}-{}.pth'.format(epoch, epoch_acc))
        print()
    ...
    torch.save(model.module.cpu().state_dict(),
               '/versa/dyy/backbone_tuned/best-{}.pth'.format(best_acc))
